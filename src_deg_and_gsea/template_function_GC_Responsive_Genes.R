...
GC_Responsive_Genes <- function(Batch_Corrected_Counts,ccbr1224_metadata) {
    ...
    specific_genes_to_include_in_heatmap = "Tsc22d3 Dusp1 Fkbp5 Nr3c1" 
...
print("template_function_GC_Responsive_Genes.R #########################################################################")
...
var_GC_Responsive_Genes<-GC_Responsive_Genes(var_Batch_Corrected_Counts,var_ccbr1224_metadata)
invisible(graphics.off())
saveRDS(var_GC_Responsive_Genes, paste0(rds_output,"/var_GC_Responsive_Genes.rds"))
