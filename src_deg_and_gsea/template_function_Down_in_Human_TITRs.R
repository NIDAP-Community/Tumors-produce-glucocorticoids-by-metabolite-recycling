...
Down_in_Human_TITRs <- function(Batch_Corrected_Counts,ccbr1224_metadata) {
...
print("template_function_Down_in_Human_TITRs.R #########################################################################")
...
var_Down_in_Human_TITRs<-Down_in_Human_TITRs(var_Batch_Corrected_Counts,var_ccbr1224_metadata)
invisible(graphics.off())
saveRDS(var_Down_in_Human_TITRs, paste0(rds_output,"/var_Down_in_Human_TITRs.rds"))
