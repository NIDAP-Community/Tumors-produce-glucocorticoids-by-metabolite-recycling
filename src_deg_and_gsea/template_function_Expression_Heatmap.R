...
Expression_Heatmap <- function(Batch_Corrected_Counts,ccbr1224_metadata) {
...
var_Expression_Heatmap<-Expression_Heatmap(var_Batch_Corrected_Counts,var_ccbr1224_metadata)
invisible(graphics.off())
