...
L2P_Upregulated_Custom <- function(DEG_Analysis,Custom_genes_L2P) {
...
print("template_function_L2P_Upregulated_Custom.R #########################################################################")
...
var_L2P_Upregulated_Custom<-L2P_Upregulated_Custom(var_DEG_Analysis,var_Custom_genes_L2P)
invisible(graphics.off())
saveRDS(var_L2P_Upregulated_Custom, paste0(rds_output,"/var_L2P_Upregulated_Custom.rds"))
