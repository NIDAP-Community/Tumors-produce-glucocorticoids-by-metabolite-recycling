...
unnamed_16 <- function(DEG_Analysis, GSEA_Preranked, Batch_Corrected_Counts, ccbr1224_metadata, msigdb_v6_2_with_orthologs) {
...
## PARAMETERS
    ...
    plot_limit = "50"
    topline = 'coordinate'
    pathways = c("GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_DN","GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_UP")
    geneid = "Gene"
    geneid_gex = "Gene"
    contrasts = c()
    species = "Mouse"
...
if (grepl("LE", which_plot)) {
    ...
    samples_to_include = setdiff(c("WT_1","WT_2","WT_3","GRfoxp3_1","GRfoxp3_2","GRfoxp3_3"), geneid)
...
png(filename="unnamed_16.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_function_unnamed_16.R #########################################################################")
...
var_unnamed_16<-unnamed_16(var_DEG_Analysis,var_GSEA_Preranked,var_Batch_Corrected_Counts,var_ccbr1224_metadata,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_unnamed_16, paste0(rds_output,"/var_unnamed_16.rds"))
