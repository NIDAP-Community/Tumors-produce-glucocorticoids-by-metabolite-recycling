...
GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_UP <- function(Batch_Corrected_Counts,ccbr1224_metadata) {
    ...
    specific_genes_to_include_in_heatmap = "Ift80 Tgfbr3 Sell Mtr Il6st Tgfbr1 Slc35g1 Itga6 Mgst2 Ggt1 Plekhg2 Itgae Ralgps2 Tspan32 Sesn1 Kcna3 Tfdp2 Rapgef6 Tnfsf8 Cep97 Pik3c2a Ldlrap1 Lef1 Pdk1 Usp28 Id3 Tox Nipal1 Nab2 Arhgdig Wdr13 Tmem184c Fnbp4 St6gal1 Plekha1 Mcoln3 Stat1 Slc28a2 Rgl2 Als2cl Tdrkh" 
...
print("template_function_GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_UP.R #########################################################################")
...
var_GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_UP<-GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_UP(var_Batch_Corrected_Counts,var_ccbr1224_metadata)
invisible(graphics.off())
saveRDS(var_GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_UP, paste0(rds_output,"/var_GSE14415_ACT_TCONV_VS_ACT_NATURAL_TREG_UP.rds"))
