...
GSEA_Visualization <- function(DEG_Analysis, GSEA_Filtered, Batch_Corrected_Counts, ccbr1224_metadata, msigdb_v6_2_with_orthologs) {
...
png(filename="GSEA_Visualization.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_function_GSEA_Visualization.R #########################################################################")
...
var_GSEA_Visualization<-GSEA_Visualization(var_DEG_Analysis,var_GSEA_Filtered,var_Batch_Corrected_Counts,var_ccbr1224_metadata,var_msigdb_v6_2_with_orthologs)
invisible(graphics.off())
saveRDS(var_GSEA_Visualization, paste0(rds_output,"/var_GSEA_Visualization.rds"))
