...
GSE42021_TREG_VS_TCONV_PLN_UP <- function(Batch_Corrected_Counts,ccbr1224_metadata) {
    ...
    specific_genes_to_include_in_heatmap = "Trim30a Lgals3bp Dram1 Serping1 Maff Ccl2 Max Zrsr1 Trim30d Ogfr Bst2 Rnf19b Ifi44 Ifitm3 Plscr1 B2m Isg20 Ctss Xaf1 Lars2 Csf1 Tmem140 Psmb10 Ifih1 Nmi Pmaip1 Ube2l6 Parp12 Cdc42ep4 Psmb9 Oas2 Ifit2 Cfb Herc6 Tlr3 Rsad2 Ifitm2 Trim12c Optn Tnfsf10 Crem Cbr3 Lap3 Cxcl10 Ddx58 Isg15 Rab27a Oas3 Cd47 Irf7 Rtp4 Ifit3b Ifi35 Tdrd7" 
...
print("template_function_GSE42021_TREG_VS_TCONV_PLN_UP.R #########################################################################")
...
var_GSE42021_TREG_VS_TCONV_PLN_UP<-GSE42021_TREG_VS_TCONV_PLN_UP(var_Batch_Corrected_Counts,var_ccbr1224_metadata)
invisible(graphics.off())
saveRDS(var_GSE42021_TREG_VS_TCONV_PLN_UP, paste0(rds_output,"/var_GSE42021_TREG_VS_TCONV_PLN_UP.rds"))
