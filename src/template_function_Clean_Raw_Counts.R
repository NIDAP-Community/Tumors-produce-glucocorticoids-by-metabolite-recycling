...
Clean_Raw_Counts <- function(ccbr1224_rawcounts) {
...
#Basic Parameters:
raw_counts_matrix=ccbr1224_rawcounts
...
var_ccbr1224_rawcounts<-readRDS(paste0(rds_output,"/var_ccbr1224_rawcounts.rds"))
Input_is_Seurat_count <- 0
for(item in var_ccbr1224_rawcounts){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_ccbr1224_rawcounts<-as.data.frame(var_ccbr1224_rawcounts)}else{var_ccbr1224_rawcounts <- var_ccbr1224_rawcounts}
invisible(graphics.off())
var_Clean_Raw_Counts<-Clean_Raw_Counts(var_ccbr1224_rawcounts)
invisible(graphics.off())
